...
goog.require('lt.objs.clients');
goog.require('lt.objs.editor');
lt.plugins.stylus.root_dir = lt.objs.plugins.find_plugin.call(null,"Stylus Language");
require(lt.objs.files.join.call(null,lt.plugins.stylus.root_dir,"codemirror","stylus"));
lt.plugins.stylus.stylus = require(lt.objs.plugins.local_module.call(null,"Stylus Language","stylus"));
