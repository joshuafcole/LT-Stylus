...
lt.plugins.stylus.relative_url_pattern = cljs.core.re_pattern.call(null,[cljs.core.str("(?m)[uU][rR][lL]\\("),cljs.core.str("[\"']?"),cljs.core.str("(?!.*?:\\/\\/)"),cljs.core.str("([^\\/\"']"),cljs.core.str(".+?)"),cljs.core.str("[\"']?\\)")].join(''));
lt.plugins.stylus.preprocess = (function preprocess(file_path,client_path,code){var matches = cljs.core.distinct.call(null,cljs.core.re_seq.call(null,lt.plugins.stylus.relative_url_pattern,code));var diff = lt.objs.files.relative.call(null,client_path,file_path);return cljs.core.reduce.call(null,((function (matches,diff){
return (function (final$,p__7975){var vec__7976 = p__7975;var url_call = cljs.core.nth.call(null,vec__7976,0,null);var path = cljs.core.nth.call(null,vec__7976,1,null);return clojure.string.replace.call(null,final$,url_call,[cljs.core.str("url(\""),cljs.core.str(diff),cljs.core.str("/"),cljs.core.str(path),cljs.core.str("\")")].join(''));
});})(matches,diff))
,code,matches);
});
...
//# sourceMappingURL=stylus_compiled.js.map